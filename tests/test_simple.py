...
class TestModularStructure(unittest.TestCase):
    ...
    def test_no_duplicate_classes(self):
        ...
        self.assertTrue(inventory_window_has_class, "ClaimInventoryWindow should be in inventory_window module")
        self.assertFalse(main_has_duplicate, "ClaimInventoryWindow should NOT be in main module")
        self.assertFalse(overlay_has_duplicate, "ClaimInventoryWindow should NOT be in overlay module")
