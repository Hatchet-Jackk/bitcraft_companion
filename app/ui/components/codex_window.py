...
class CodexProfessionTab(ctk.CTkFrame):
    ...
    def __init__(self, parent, profession_name: str):
    ...
    def _create_widgets(self):
        ...
        # Create frame for treeview and scrollbar - consistent with main window padding
...
class CodexWindow(ctk.CTkToplevel, SearchableWindowMixin):
    ...
    def _create_profession_tabs(self):
        ...
        for profession in self.professions:
            tab = CodexProfessionTab(self.tab_content_area, profession)
